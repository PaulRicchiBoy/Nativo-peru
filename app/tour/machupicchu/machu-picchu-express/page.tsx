...
import { ArrowRight, Clock, DollarSign, Train } from 'lucide-react';

export default function MachuPicchuExpressPage() {
  const { language } = useLanguage();
  
  // Filtrar tours de Machu Picchu Express
  const machuPicchuTours = tours.filter(tour => 
    tour.id.includes('machu-picchu-express') || 
    tour.id.includes('machu-picchu-full-day')
  );
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex items-center gap-4 mb-4">
          ...
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white">
            {language === 'es' ? 'Machu Picchu Express' : 'Machu Picchu Express'}
          </h1>
        </div>
        <p className="text-xl text-gray-600 dark:text-gray-400 mb-12">
          {language === 'es' 
            ? 'La forma más rápida y cómoda de visitar la maravilla del mundo'
            : 'The fastest and most comfortable way to visit the wonder of the world'}
        </p>
